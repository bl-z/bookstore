...
public class OrderServiceImpl implements OrderService {
	...
	public Integer updateOrder(String orderId, String orderStatus, Double totalPrice, String consignee, String mobile,
		...
		String province1 = "省份".equals(province) ? "" : province;
		String city1 = "城市".equals(city) ? "" : city;
		String county1 = "县/区".equals(county) ? "" : county;
		String detail1 = "".equals(detail) && "" != county1 ? "自取" : detail;
		
		Integer rows = od.updateOrder(orderId, orderStatus, totalPrice, consignee, mobile, province1, city1, county1, detail1);
		return rows;
	}
