...
public class PurchaseController {
	...
	public @ResponseBody JsonData postPurchase(@RequestParam("purchaseBatch") String purchaseBatch,
			...
			@RequestParam("supplier") Integer supplier, @RequestParam("purchaseStatus") String purchaseStatus,
		...
		return new JsonData("postPurchase",
				ps.postPurchase(purchaseBatch, purchaseDate, empId, supplier, purchaseStatus, purchaseLog), "插入数据",
				true);
	}
