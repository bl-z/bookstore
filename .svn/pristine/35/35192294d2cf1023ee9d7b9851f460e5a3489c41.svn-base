...
<body>
	...
	<div id="toolbar">
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="salesReturn()">确认退货</a>
	</div>
		...
		<form id="fm" method="post">
			...
			<div class="fitem">
				...
				<select id="province" name="province" onchange="doProvAndCityRelation()">
					<option id="choosePro">省份</option>
				</select>
				<select id="citys" name="citys" onchange="doCityAndCountyRelation()">
					<option id="chooseCity">城市</option>
				</select> 
				<select id="county" name="county">
					<option  id="chooseCounty">县/区</option>
				</select> 
			</div>
			...
			<div class="fitem">
				<label>订单状态:</label>
				<select id="orderStatus1" class="easyui-combobox" name="orderStatus1" style="width:100px;">   
